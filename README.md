# Project 4 - *Memory Card Game*

Submitted by: **Gabriel Sosa**

**Memory Card Game** is an app that presents the user a selection of cards and has them match them, whenever they pick two, those cards are compared and if they are the same, they are removed, otherwise, they are flipped down
...
[![Watch the video](https://img.youtube.com/vi/7fEFPOurSIk/maxresdefault.jpg)](https://youtu.be/7fEFPOurSIk)

## Notes

I made this app using my girlfriend's mac, her name is Gabriella Valdes so some of the files may say they were made by them

## License

    Copyright [2025] [Gabriel Sosa]
